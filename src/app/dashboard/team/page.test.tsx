...
describe('DashboardTeamPage server component', () => {
	...
	it('renders team shell for managers', async () => {
		...
		expect(renderToStaticMarkup(result as React.ReactElement)).toContain('WORKFLOW_SHELL:Team workload:team');
	});
});
