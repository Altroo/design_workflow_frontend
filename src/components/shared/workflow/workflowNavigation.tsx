...
import { Bell, BriefcaseBusiness, CircleUserRound, FolderKanban, KeyRound, LayoutDashboard, MessagesSquare, Shield, Users } from 'lucide-react';
import type { TranslationDictionary } from '@/types/languageTypes';
import { DASHBOARD_BOARD, DASHBOARD_CHAT, DASHBOARD_EDIT_PROFILE, DASHBOARD_MY_WORK, DASHBOARD_NOTIFICATIONS, DASHBOARD_OVERVIEW, DASHBOARD_PASSWORD, DASHBOARD_PROJECTS, DASHBOARD_REPORTS_TIME, DASHBOARD_TEAM, USERS_ADD, USERS_LIST } from '@/utils/routes';
...
export const getWorkflowNavigation = (t: TranslationDictionary, hasManagerAccess: boolean, unreadNotifications = 0): WorkflowNavItem[] => [
	hasManagerAccess
	...
	...(hasManagerAccess ? [{ label: t.navigation.reports, path: DASHBOARD_REPORTS_TIME, icon: <Shield size={16} /> }] : []),
	{ label: t.navigation.notifications, path: DASHBOARD_NOTIFICATIONS, icon: <Bell size={16} />, badge: unreadNotifications },
];
